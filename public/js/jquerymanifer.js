(function (global, factory) {
  ...
  (varrxhtmlTag = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([a-z][^\/\0>\x20\t\r\n\f]*)[^>]*)\/>/gi),
  ...
  (varrdisplayswap = /^(none|table(?!-c[ea]).+)/),
    (rcustomProp = /^--/),
    (cssShow = {
      position: "absolute",
      visibility: "hidden",
  ...
  (var_jQuery = window.jQuery), (_$ = window.$);
